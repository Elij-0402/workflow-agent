...
### Sub-AGENTS.md cross-reference

Four nested AGENTS.md files own local conventions — read whichever sits closest to the file you're editing. Local rules win over this root file when they conflict.
