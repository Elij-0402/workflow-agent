...
- @D:/workflow-agent/.claude/get-shit-done/workflows/complete-milestone.md (main workflow)
- @D:/workflow-agent/.claude/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
