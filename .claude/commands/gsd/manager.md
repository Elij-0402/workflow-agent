...
<execution_context>
@D:/workflow-agent/.claude/get-shit-done/workflows/manager.md
...
Read and execute `D:/workflow-agent/.claude/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
