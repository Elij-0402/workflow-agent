...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/workflow-agent/.claude/.gsd-surface.json`
(sibling to `D:/workflow-agent/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/workflow-agent/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/workflow-agent/.claude/skills`).
...
`D:/workflow-agent/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/workflow-agent/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/workflow-agent/.claude/.gsd-surface.json`
Install profile marker: `D:/workflow-agent/.claude/.gsd-profile`
Skill dirs: `D:/workflow-agent/.claude/skills/gsd-*/`
Engine module: `D:/workflow-agent/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/workflow-agent/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
