...
```
Agent(
  prompt="Read D:/workflow-agent/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/workflow-agent/.claude/get-shit-done/templates/VALIDATION.md`
