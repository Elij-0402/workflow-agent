...
<required_reading>
@D:/workflow-agent/.claude/get-shit-done/references/ai-frameworks.md
@D:/workflow-agent/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/workflow-agent/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/workflow-agent/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/workflow-agent/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/workflow-agent/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/workflow-agent/.claude/agents/gsd-eval-planner.md for instructions.
