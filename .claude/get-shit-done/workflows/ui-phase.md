...
```markdown
Read D:/workflow-agent/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/workflow-agent/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/workflow-agent/.claude/agents/gsd-ui-checker.md for instructions.
