...
@D:/workflow-agent/.cursor/get-shit-done/references/thinking-models-research.md
...
```bash
node "D:/workflow-agent/.cursor/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
