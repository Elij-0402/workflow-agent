...
Reference full template: `D:/workflow-agent/.cursor/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/workflow-agent/.cursor/get-shit-done/templates/state.md`.
