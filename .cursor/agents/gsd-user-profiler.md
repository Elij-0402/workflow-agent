...
<reference>
@D:/workflow-agent/.cursor/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/workflow-agent/.cursor/get-shit-done/references/user-profiling.md` to load:
