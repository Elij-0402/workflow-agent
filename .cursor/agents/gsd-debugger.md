...
<required_reading>
@D:/workflow-agent/.cursor/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/workflow-agent/.cursor/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/workflow-agent/.cursor
                  → checks D:/workflow-agent/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/workflow-agent/.cursor/get-shit-done
                  → writes to D:/workflow-agent/.cursor/get-shit-done/hooks/
...
@D:/workflow-agent/.cursor/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/workflow-agent/.cursor/get-shit-done/references/common-bug-patterns.md
