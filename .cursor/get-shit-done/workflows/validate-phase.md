...
```
Agent(
  prompt="Read D:/workflow-agent/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/workflow-agent/.cursor/get-shit-done/templates/VALIDATION.md`
