...
<template>
@D:/workflow-agent/.cursor/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/workflow-agent/.cursor/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/workflow-agent/.cursor/get-shit-done/workflows/transition.md`.
...
- Follow @D:/workflow-agent/.cursor/get-shit-done/workflows/diagnose-issues.md
