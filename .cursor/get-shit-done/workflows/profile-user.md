...
Key references:
- @D:/workflow-agent/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @D:/workflow-agent/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/workflow-agent/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/workflow-agent/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/workflow-agent/.cursor/get-shit-done/USER-PROFILE.md" "D:/workflow-agent/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/workflow-agent/.cursor/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/workflow-agent/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @D:/workflow-agent/.cursor/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/workflow-agent/.cursor/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to D:/workflow-agent/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/workflow-agent/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/workflow-agent/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/workflow-agent/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="D:/workflow-agent/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    D:/workflow-agent/.cursor/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/workflow-agent/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        D:/workflow-agent/.cursor/.cursor/rules/
```
