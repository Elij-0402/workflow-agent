...
```
Agent(
  prompt="Read D:/workflow-agent/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/workflow-agent/.cursor/get-shit-done/templates/SECURITY.md`
