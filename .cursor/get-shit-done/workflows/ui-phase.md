...
```markdown
Read D:/workflow-agent/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/workflow-agent/.cursor/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/workflow-agent/.cursor/agents/gsd-ui-checker.md for instructions.
