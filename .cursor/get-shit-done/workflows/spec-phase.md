...
```bash
INIT=$(node "D:/workflow-agent/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/workflow-agent/.cursor/get-shit-done/templates/spec.md.
