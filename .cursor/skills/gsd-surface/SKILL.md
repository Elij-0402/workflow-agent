...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/workflow-agent/.cursor/.gsd-surface.json`
(sibling to `D:/workflow-agent/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/workflow-agent/.cursor/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/workflow-agent/.cursor/skills`).
...
`D:/workflow-agent/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/workflow-agent/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/workflow-agent/.cursor/.gsd-surface.json`
Install profile marker: `D:/workflow-agent/.cursor/.gsd-profile`
Skill dirs: `D:/workflow-agent/.cursor/skills/gsd-*/`
Engine module: `D:/workflow-agent/.cursor/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/workflow-agent/.cursor/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
