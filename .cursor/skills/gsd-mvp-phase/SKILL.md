...
<execution_context>
@D:/workflow-agent/.cursor/get-shit-done/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @D:/workflow-agent/.cursor/get-shit-done/workflows/mvp-phase.md end-to-end.
