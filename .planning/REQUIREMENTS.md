...
- [x] **IA-03**: 次要能力（Studio、对比、单书、资料库）默认折叠或二级入口，高级用户仍可直达
...
- [x] **QLT-01**: 现有 188+ 单元测试保持通过；变更不破坏 generate-v2 / blueprint confirm 闭环
- [x] **QLT-02**: 所有者主观验收：愿意每天打开使用
- [x] **QLT-03**: 外观达到成熟 SaaS 水准（克制、留白、一致），功能清单相对 v0.3 不缩减
